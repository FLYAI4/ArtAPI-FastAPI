...
# Mockup
IMG_PATH = os.path.abspath(os.path.join(test_img_path, "origin_img.jpg"))
SEED = 0
CFG_SCALE = 2.5
MOTION_BUCKET_ID=40
GENERATE_ORIGIN_VIDEO_PATH = os.path.abspath(os.path.join(test_img_path, "generate_origin_video.mp4"))
REVERSED_VIDEO_PATH = os.path.abspath(os.path.join(test_img_path, "reversed_video.mp4"))
SLOW_VIDEO_PATH = os.path.abspath(os.path.join(test_img_path, "slow_video.mp4"))
